...
The following two model architectures have been implemented in PyTorch and are inspired by the GitHub repositories \cite{graviraja2019}, \cite{freia2020}.
...
As was previously discussed, our current setup uses robot simulations composed of revolute joints. In the future we plan on also using prismatic joints.
