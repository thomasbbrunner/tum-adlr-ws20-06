...
%%%%%%%%%%%%%%%%%%%%%%
\begin{table*}[h]
\caption{Hyperparameters for cvae which has been trained on a planar robot with $N$ DoF with $N=[4, 6, 10, 15]$.}
...
\begin{table*}[h]
\caption{Hyperparameters for inn which has been trained on a planar robot with $N$ DoF with $N=[4, 6, 10, 15]$.}
